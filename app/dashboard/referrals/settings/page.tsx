...
// Define rank colors with proper branding
const rankColors = {
  [AgentRank.BRONZE]: {
...
interface ReferralSettings {
  ...
  rankThresholds: {
    [AgentRank.BRONZE]: number;
    [AgentRank.SILVER]: number;
    [AgentRank.GOLD]: number;
    [AgentRank.PLATINUM]: number;
  };
}
...
export default function ReferralSettingsPage() {
  ...
  const defaultSettings: ReferralSettings = {
    ...
    rankThresholds: {
      ...
      [AgentRank.SILVER]: 15,
      [AgentRank.GOLD]: 30,
      [AgentRank.PLATINUM]: 50,
    },
  };

  // Settings state
  const [currentSettings, setCurrentSettings] =
    useState<ReferralSettings>(defaultSettings);
  ...
  // Calculate commission rate for a rank
  const getCommissionRate = (
    rank: AgentRank,
    type: "investment" | "property" = "investment"
  ) => {
    if (commissionRates && commissionRates[rank]) {
      return commissionRates[rank][type];
    }

    // Fallback values if context data isn't available
    const fallbackRates = {
      [AgentRank.BRONZE]: { investment: 2, property: 1 },
      [AgentRank.SILVER]: { investment: 3, property: 1.5 },
      [AgentRank.GOLD]: { investment: 4, property: 2 },
      [AgentRank.PLATINUM]: { investment: 5, property: 2.5 },
    };
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Configure your referral program settings and commission
                structure
              </p>
            </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Your referral program is active and running
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div className="flex items-center">
                      <div
                        className={`p-3 rounded-full mr-4 ${
                          rankColors[agentRankInfo.currentRank].bg
                        }`}
                      >
                        <Award
                          className={`h-5 w-5 ${
                            rankColors[agentRankInfo.currentRank].text
                          }`}
                        />
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          {agentRankInfo.requiredReferrals} referrals to{" "}
                    ...
                    <div className="w-full md:w-1/3">
                      ...
                      >
                        <div
                          className={`h-full ${
                            rankColors[agentRankInfo.currentRank].progress
                          }`}
                ...
                <Card className="border-none shadow-lg bg-white dark:bg-slate-900 overflow-hidden">
                  <CardHeader className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800 px-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <CardDescription>
                          Configure the commission rates for different actions
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6 space-y-6">
                      ...
                      <div className="flex justify-between">
                        ...
                        >
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              Fixed amount paid for each successful signup
                              referral
                            </TooltipContent>
                          </Tooltip>
                        </Label>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        >
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              Percentage of investment amount paid as commission
                            </TooltipContent>
                          </Tooltip>
                        </Label>
                        <Badge
                      ...
                      <div className="pt-2 flex items-center gap-4">
                        <Slider
                          ...
                          onValueChange={(value) =>
                            updateSetting(
                              "investmentCommissionPercentage",
                              value[0]
                            )
                          }
                          className="flex-1"
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        >
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              Percentage of purchase amount paid as commission
                            </TooltipContent>
                          </Tooltip>
                        </Label>
                        <Badge
                      ...
                      <p className="text-xs text-muted-foreground">
                        Percentage of property purchase amount paid as
                        commission
                      </p>
                    </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-violet-700 dark:text-violet-400 mt-1">
                            Based on your current settings, the average
                            commission per referral is approximately{" "}
                            <span className="font-medium">
                              {formatCurrency(
                  ...
                  <CardHeader className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800 px-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <CardDescription>
                          Configure when and how commissions are paid out
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6 space-y-6">
                      ...
                      <div className="flex justify-between">
                        ...
                        >
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              Minimum amount required before commission is paid
                              out
                            </TooltipContent>
                          </Tooltip>
                        </Label>
                    ...
                    <div className="space-y-3">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          updateSetting("payoutFrequency", value)
                        }
                      >
                        <SelectTrigger
                          id="payoutFrequency"
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between space-x-2">
                        ...
                        <Badge
                          variant={
                            currentSettings.autoApproval ? "default" : "outline"
                          }
                          className={
                      ...
                      <p className="text-xs text-muted-foreground">
                        When enabled, commissions are automatically approved
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-indigo-700 dark:text-indigo-400 mt-1">
                            Commissions are paid directly to your connected bank
                            account or wallet. You can manage your payout
                  ...
                  <CardHeader className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800 px-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <CardDescription>
                          Configure how referral links work
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            The prefix used in referral links
                          </TooltipContent>
                        </Tooltip>
                      </Label>
                      <div className="flex items-center space-x-2">
                        <Input
                          ...
                          onChange={(e) =>
                            updateSetting("referralLinkPrefix", e.target.value)
                          }
                          className="bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700"
                        />
                      </div>
                      <div className="text-xs text-muted-foreground flex items-center mt-1">
                        ...
                        <code className="bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded text-xs">
                          yourdomain.com/{currentSettings.referralLinkPrefix}
                          /USER_CODE
                        </code>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        >
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              Number of days before a referral link expires (0
                              for never)
                            </TooltipContent>
                          </Tooltip>
                        </Label>
                      ...
                      <div className="pt-2 flex items-center gap-4">
                        <Slider
                          ...
                          step={1}
                          onValueChange={(value) =>
                            updateSetting("referralLinkExpiry", value[0])
                          }
                          className="flex-1"
                        />
                      ...
                      <p className="text-xs text-muted-foreground">
                        Number of days before a referral link expires (0 for
                        never)
                      </p>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        >
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              Days before a user can generate a new referral
                              link
                            </TooltipContent>
                          </Tooltip>
                        </Label>
                      ...
                      <div className="pt-2 flex items-center gap-4">
                        <Slider
                          ...
                          step={1}
                          onValueChange={(value) =>
                            updateSetting("cooldownPeriod", value[0])
                          }
                          className="flex-1"
                        />
                        <div className="relative w-24">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Days before a user can generate a new referral link (0
                        for no cooldown)
                      </p>
                    </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-amber-700 dark:text-amber-400 mt-1">
                            All referral links are cryptographically signed to
                            prevent tampering and include tracking parameters
                ...
                <Card className="border-none shadow-lg bg-white dark:bg-slate-900 overflow-hidden">
                  <CardHeader className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800 px-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <CardDescription>
                          Configure the rules for your referral program
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6 space-y-6">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        >
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              Maximum number of referrals a user can have
                            </TooltipContent>
                          </Tooltip>
                        </Label>
                        <Badge variant="outline" className="font-mono">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        Maximum number of referrals a user can have (0 for
                        unlimited)
                      </p>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between space-x-2">
                        <div className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              updateSetting("multiTierReferral", checked)
                            }
                          />
                          <Label
                            htmlFor="multiTierReferral"
                            className="flex items-center"
                          >
                            ...
                            <Tooltip>
                              ...
                              <TooltipContent>
                                When enabled, users can earn commissions from
                                referrals made by their referrals
                              </TooltipContent>
                            </Tooltip>
                          </Label>
                        </div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        When enabled, users can earn commissions from referrals
                      ...
                      <div className="flex items-center justify-between space-x-2 pt-2">
                        <div className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              updateSetting("dashboardNotifications", checked)
                            }
                          />
                          <Label htmlFor="dashboardNotifications">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-emerald-700 dark:text-emerald-400 mt-1">
                            Our system automatically detects and prevents
                            fraudulent referrals using advanced algorithms and
                            IP tracking.
                          </p>
                        </div>
                      </div>
              ...
              <Card className="border-none shadow-lg bg-white dark:bg-slate-900 overflow-hidden">
                <CardHeader className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800 px-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <CardDescription>
                        Configure commission rates and thresholds for each agent
                        rank
                      </CardDescription>
                    </div>
                  </div>
                ...
                <CardContent className="p-6">
                            ...
                            <div className="flex items-center">
                              <div
                                className={`h-10 w-10 rounded-full ${
                                  rankColors[AgentRank.BRONZE].bg
                                } flex items-center justify-center mr-3`}
                              >
                                <Award
                                  className={`h-5 w-5 ${
                                    rankColors[AgentRank.BRONZE].text
                                  }`}
                                />
                              </div>
                              <div>
                            ...
                            <div className="flex flex-col">
                              <div className="flex items-center space-x-2">
                                <Badge
                                  ...
                                  className="font-mono bg-violet-50 text-violet-600 border-violet-200 dark:bg-violet-900/20 dark:text-violet-400 dark:border-violet-800"
                                >
                                  {getCommissionRate(AgentRank.BRONZE)}%
                                </Badge>
                          ...
                          <TableCell>
                            <div className="flex items-center space-x-3">
                              <Input
                                type="number"
                                value={
                                  currentSettings.rankThresholds[
                                    AgentRank.BRONZE
                                  ]
                                }
                                onChange={(e) =>
                        ...
                        <TableRow>
                          <TableCell>
                            <div className="flex items-center">
                              <div
                                className={`h-10 w-10 rounded-full ${
                                  rankColors[AgentRank.SILVER].bg
                                } flex items-center justify-center mr-3`}
                              >
                                <Award
                                  className={`h-5 w-5 ${
                                    rankColors[AgentRank.SILVER].text
                                  }`}
                                />
                              </div>
                              <div>
                            ...
                            <div className="flex flex-col">
                              <div className="flex items-center space-x-2">
                                <Badge
                                  ...
                                  className="font-mono bg-violet-50 text-violet-600 border-violet-200 dark:bg-violet-900/20 dark:text-violet-400 dark:border-violet-800"
                                >
                                  {getCommissionRate(AgentRank.SILVER)}%
                                </Badge>
                                <span className="text-xs text-muted-foreground">
                                  Investment
                                </span>
                        ...
                        <TableRow>
                          <TableCell>
                            <div className="flex items-center">
                              <div
                                className={`h-10 w-10 rounded-full ${
                                  rankColors[AgentRank.GOLD].bg
                                } flex items-center justify-center mr-3`}
                              >
                                <Award
                                  className={`h-5 w-5 ${
                                    rankColors[AgentRank.GOLD].text
                                  }`}
                                />
                              </div>
                              <div>
                            ...
                            <div className="flex flex-col">
                              <div className="flex items-center space-x-2">
                                <Badge
                                  ...
                                  className="font-mono bg-violet-50 text-violet-600 border-violet-200 dark:bg-violet-900/20 dark:text-violet-400 dark:border-violet-800"
                                >
                                  {getCommissionRate(AgentRank.GOLD)}%
                                </Badge>
                                <span className="text-xs text-muted-foreground">
                                  Investment
                                </span>
                          ...
                          <TableCell>
                            <div className="flex items-center space-x-3">
                              <Input
                                type="number"
                                value={
                                  currentSettings.rankThresholds[AgentRank.GOLD]
                                }
                                onChange={(e) =>
                                  updateNestedSetting(
                                    "rankThresholds",
                        ...
                        <TableRow>
                          <TableCell>
                            <div className="flex items-center">
                              <div
                                className={`h-10 w-10 rounded-full ${
                                  rankColors[AgentRank.PLATINUM].bg
                                } flex items-center justify-center mr-3`}
                              >
                                <Award
                                  className={`h-5 w-5 ${
                                    rankColors[AgentRank.PLATINUM].text
                                  }`}
                                />
                              </div>
                              <div>
                            ...
                            <div className="flex flex-col">
                              <div className="flex items-center space-x-2">
                                <Badge
                                  ...
                                  className="font-mono bg-violet-50 text-violet-600 border-violet-200 dark:bg-violet-900/20 dark:text-violet-400 dark:border-violet-800"
                                >
                                  {getCommissionRate(AgentRank.PLATINUM)}%
                                </Badge>
                                <span className="text-xs text-muted-foreground">
                                  Investment
                                </span>
                  ...
                  <div className="mt-8 space-y-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Users will automatically progress through tiers as they
                      reach the required number of successful referrals.
                    </p>
                    ...
                    <div className="space-y-8">
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span>
                            {currentSettings.rankThresholds[AgentRank.BRONZE]}+
                            referrals
                          </span>
                        </div>
                        <Progress
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span>
                            {currentSettings.rankThresholds[AgentRank.SILVER]}+
                            referrals
                          </span>
                        </div>
                        <Progress
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span>
                            {currentSettings.rankThresholds[AgentRank.PLATINUM]}
                            + referrals
                          </span>
                        </div>
                        <Progress
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            Commission rates are set at the system level and
                            cannot be modified here. Please contact your account
                            manager to discuss adjusting these rates.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <CardFooter className="p-6 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800">
                  <div className="w-full">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      {agentRankInfo && (
                        <Badge
                          className={`bg-gradient-to-r from-violet-500 to-indigo-500 hover:from-violet-600 hover:to-indigo-600 border-none`}
                        >
