...
export default function InvestmentsPage() {
  ...
  const { filteredInvestments, isLoading, filters, sortOption, setFilters, setSortOption, fetchInvestments } =
    useInvestments()
    ...
    <div className="space-y-6">
      <FadeIn>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white">Estate Investments</h1>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Select
                ...
                onValueChange={(value) => setSortOption({ field: value, direction: sortOption.direction })}
              >
                <SelectTrigger className="w-[140px] bg-[#1F1F23]/50 border-[#2B2B30]">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="w-full sm:w-1/2">
                <Slider
                  ...
                  max={20}
                  step={1}
                  onValueChange={(value) => setFilters({ returnRateRange: value as [number, number] })}
                  className="w-full"
                />
              </div>
            </div>
