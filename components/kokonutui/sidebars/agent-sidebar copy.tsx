...
export default function AgentSidebar() {
  ...
  // Create a custom Dialog component that properly handles the backdrop
  const CustomDialog = ({
    children,
    ...props
  ...
  return (
    <div className="h-[100vh]  flex flex-col">
      <motion.button
        type="button"
        className="lg:hidden fixed top-4 left-4 p-2 rounded-lg bg-white/90 dark:bg-[#0F0F12]/80 backdrop-blur-md shadow-md"
      ...
      <AnimatePresence>
        {(isMobileMenuOpen || isDesktop) && (
          <motion.nav
            className="fixed inset-y-0 left-0 z-[60] w-64 bg-white/90 backdrop-blur-md lg:static lg:w-64 border-r border-gray-200 dark:bg-[#0F0F12]/80 dark:border-[#1F1F23] flex flex-col"
          ...
          >
            <div className="flex flex-col flex-1">
              ...
              <div className="flex-1 overflow-y-auto py-4 px-4 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-[#1F1F23] scrollbar-track-transparent max-h-[calc(100vh-8rem)]">
                <motion.div
                  className="space-y-4"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  ...
                  {/* Investments Section (for estates) */}
                  <div>
                    <button
      ...
      <AnimatePresence>
        {isMobileMenuOpen && !isDesktop && !showAccountDialog && (
          <motion.div
      ...
      {/* Custom full-screen backdrop for the dialog */}
      <AnimatePresence>
        {showAccountDialog && (
          <motion.div
      ...
      <Dialog open={showAccountDialog} onOpenChange={setShowAccountDialog}>
        <DialogContent className="sm:max-w-md bg-white dark:bg-[#0F0F12]/90 backdrop-blur-xl border-gray-200 dark:border-[#1F1F23] z-50">
          <DialogHeader>
          ...
          <div className="py-2">
            ...
            <div className="mt-4 p-3 rounded-lg bg-gray-100 dark:bg-[#1F1F23]/50 backdrop-blur-sm">
              ...
              <p className="mt-1 text-xs text-gray-600 dark:text-gray-400">
                Property sales and referral management
              </p>
            </div>
