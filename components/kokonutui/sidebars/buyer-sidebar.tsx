...
export default function BuyerSidebar() {
  ...
  function handleChatWithAdmin() {
    ...
    window.open(
      "https://wa.me/1234567890?text=Hello%20Esthington%20Admin,%20I%20need%20assistance%20with%20my%20account.",
      "_blank"
    );
  }
          ...
          <div className="py-4">
            ...
            <div className="mt-4 p-3 rounded-lg bg-gray-100 dark:bg-[#1F1F23]/50 backdrop-blur-sm">
              <div className="flex items-center">
                <ShoppingBasket className="h-5 w-5 mr-2 text-secondary" />
