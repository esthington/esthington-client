    ...
    <div className="z-30 flex flex-col">
      ...
      <AnimatePresence>
        {(isMobileMenuOpen || isDesktop) && (
          <motion.nav
            className="fixed h-screen inset-y-0 left-0 z-[70] w-64 bg-white/90 backdrop-blur-md lg:static lg:w-64 border-r border-gray-200 dark:bg-[#0F0F12]/80 dark:border-[#1F1F23] flex flex-col"
          ...
          >
            <div className="flex flex-col flex-1 h-full">
              ...
              <div className="flex-1 overflow-y-auto h-[60%] py-4 px-4 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-[#1F1F23] scrollbar-track-transparent">
                <motion.div
                  className="space-y-4"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
